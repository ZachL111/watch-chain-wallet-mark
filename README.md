...
watch-chain-wallet-mark is a C project for blockchain tooling. It focuses on this technical goal: Implement a C blockchain tooling project for wallet incremental indexing, using append-only fixtures and checkpoint recovery checks.
...
The core module exposes a small scoring API. Inputs are simple numeric signals: demand, capacity, latency, risk, and weight. The score uses a threshold of 161, risk penalty 7, latency penalty 3, and weight bonus 4. Tests exercise the public API against the fixture cases in `fixtures/cases.csv`.
