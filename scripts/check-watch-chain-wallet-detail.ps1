...
$repo = "watch-chain-wallet-mark"
$language = "C"
$category = "Blockchain tooling"

foreach ($path in @("metadata/domain-review.json", "config/review-profile.json", "fixtures/domain_review.csv", "docs/field-notes.md", "docs/review-journal.md", "examples/watch-chain-wallet-walkthrough.md")) {
