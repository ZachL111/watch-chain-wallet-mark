"""Regression checks for the watch-chain-wallet-mark casebook."""
...
from casebook.harness import assert_expected, watch_chain_wallet_mark_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(watch_chain_wallet_mark_summary(), assert_expected())
